...
//                   <div
//                     key={column.value}
//                     className={`flex max-h-[calc(100vh-13rem)] min-h-96 w-64 shrink-0 flex-col rounded-xl border border-slate-200 shadow-sm ${
...
//                           <h2 className="truncate text-xs font-black uppercase tracking-wide">{column.label}</h2>
